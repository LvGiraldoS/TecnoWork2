      ...
      <table width="539" border="0" align="center"  bordercolor="#02727D">
        ...
        <tr>
          ...
          <td><label for="numDoc"></label>
            <input name="numDoc" type="text" id="numDoc" size="29" /></td>
        </tr>
        <tr>
          <td class="fuenteRegistro2">NOMBRES:</td>
          <td><input name="nombre1" type="text" id="nombre1" size="29" /></td>
        </tr>
        <tr>
          <td class="fuenteRegistro2">PRIMER APELLIDO:</td>
          <td><input name="apellido1" type="text" id="apellido1" size="29" /></td>
        </tr>
        <tr>
          <td class="fuenteRegistro2">SEGUNDO APELLIDO:</td>
          <td><input name="apellido2" type="text" id="nombre4" size="29" /></td>
        </tr>
        <tr>
          ...
          <td><label for="dia"></label>
            ...
            <select name="dia" size="1" id="dia">
              <option value="Dia" selected="selected">Día</option>
        ...
        <tr>
          ...
          <td><input name="telefono2" type="text" id="telefono2" size="29" /></td>
        </tr>
      </table>
      <p>&nbsp;</p>
    </form></td>
